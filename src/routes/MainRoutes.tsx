...
//lead
const LeadDetails = Loadable(lazy(()=>import('pages/lead/lead-details')))
const LeadSearchMenu =Loadable(lazy(() => import('pages/lead/LeadSearchMenu')))


// role and permission
const Role = Loadable(lazy(()=> import('pages/role-permission/Role')));
const Permission = Loadable(lazy(()=> import('pages/role-permission/Permission')));
const RoleAndPermssion = Loadable(lazy(()=> import('pages/role-permission/RoleAndPermission')))


// status
const AccommodationStatus = Loadable(lazy(()=>import('pages/status/AccommodationStatus')));
const EducationStatus = Loadable(lazy(()=>import('pages/status/EducationStatus')));
const LeadStatus = Loadable(lazy(()=>import('pages/status/LeadStatus')));
const SourceStatus = Loadable(lazy(()=>import('pages/status/SourceStatus')));
const AccountStatus = Loadable(lazy(()=>import('pages/status/AccountStatus')));
const LegalStatus = Loadable(lazy(()=>import('pages/status/LegalStatus')));
const HarassmentStatus = Loadable(lazy(()=>import('pages/status/HarassmentStatus')));
const PaymentStatus = Loadable(lazy(()=>import('pages/status/PaymentStatus')));
const BankType = Loadable(lazy(()=>import('pages/status/BankType')));
const TypeOfCredit = Loadable(lazy(()=>import('pages/status/TypeOfCredit')));
// ==============================|| MAIN ROUTES ||============================== //
