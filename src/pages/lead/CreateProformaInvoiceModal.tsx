...
export default function CreateProformaInvoiceModal({ open, onClose, onSave }: CreateInvoiceModalProps) {
  ...
  const validationSchema = Yup.object({
    ...
    proformaInvoiceOwner:Yup.string().required('Proforma Invoice Owner is required'),
    accountManager :Yup.string().required('Account Manager is required'),
    modifyby: Yup.string().required('Modify is required'),
    ...
    managementFeesInclusiveTaxes: Yup.number()
      .required('Management Fees Inclusive Taxes is required')
      .min(0, 'Must be greater than or equal to 0'),
    managementFeesExclusiveTaxes: Yup.number()
      .required('Management Fees Exclusive of Taxes is required')
      .min(0, 'Must be greater than or equal to 0'),
    ...
    creditorAmountPaidByClient: Yup.number()
      .required('Creditor Amount Paid by Client is required')
      .min(0, 'Must be greater than or equal to 0'),
            ...
            <DialogContent sx={{ padding: '24px', backgroundColor: '#f7f7f7' }}>
              ...
              <Grid item xs={12} md={6}>
                ...
                <Grid item xs={12} md={6}>
                  <TextField
                    fullWidth
                    id="proformaInvoiceOwner"
                    name="proformaInvoiceOwner"
                    label="Proforma Invoice Owner"
                    value={formik.values.proformaInvoiceOwner}
                    onChange={formik.handleChange}
                    error={formik.touched.proformaInvoiceOwner && Boolean(formik.errors.proformaInvoiceOwner)}
                    helperText={formik.touched.proformaInvoiceOwner && formik.errors.proformaInvoiceOwner}
                  />
                </Grid>
                <Grid item xs={12} md={6}>
                  <TextField
                ...
                <Grid item xs={12} md={6}>
                  <TextField
                    ...
                    name="modifyby"
                    label="Modify"
                    value={formik.values.modifyby}
                    onChange={formik.handleChange}
                    error={formik.touched.modifyby && Boolean(formik.errors.modifyby)}
                    helperText={formik.touched.modifyby && formik.errors.modifyby}
                  >
              ...
              <Grid container spacing={2}>
                ...
                <Grid item xs={12}>
                  <div
                    {...getRootProps()}
                    style={{ border: '2px dashed #e74c3c', padding: '20px', textAlign: 'center', borderRadius: '8px' }}
                  >
                    <input {...getInputProps()} />
                  ...
                  <Typography variant="body2" color="textSecondary">
                    {uploadedFiles.length > 0 ? `Uploaded: ${uploadedFiles.map((file) => file.name).join(', ')}` : 'No files uploaded'}
                  </Typography>
                </Grid>
              </Grid>
            </DialogContent>
